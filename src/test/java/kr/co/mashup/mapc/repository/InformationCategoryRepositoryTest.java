 ...
 */
public class InformationCategoryRepositoryTest extends DataJpaTestContext {

    @Autowired
    private InformationCategoryRepository sut;
    ...
    public void setUp() throws Exception {
        ...
        Information information = Information.builder()
                ...
                .title("두레유")
                .content("#한식 #전통 #미쉐린\n종로구 북촌로 65")
                .imageUrl("https://assets-cdn.github.com/images/modules/site/integrators/travis-ci.png")
                .build();
        testEntityManager.persistAndFlush(information);

        InformationCategory informationCategory = InformationCategory.builder()
                .category(category)
                .information(information)
                .build();
        sut.save(informationCategory);
    }
