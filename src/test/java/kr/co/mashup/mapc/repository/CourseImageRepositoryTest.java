...
import kr.co.mashup.mapc.entity.CourseImage;
 ...
 */
public class CourseImageRepositoryTest extends DataJpaTestContext {

    @Autowired
    private CourseImageRepository sut;
